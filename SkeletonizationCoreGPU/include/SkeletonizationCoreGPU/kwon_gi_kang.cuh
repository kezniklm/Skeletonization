...
{
	class kwon_gi_kang final : public ::skeletonizer::algorithms::kwon_gi_kang, public backend_gpu<14, 14>
	{
	public:
...
void kwon_gi_kang_iteration(const cv::cuda::GpuMat& src, const cv::cuda::GpuMat& dst, bool first_pass,
