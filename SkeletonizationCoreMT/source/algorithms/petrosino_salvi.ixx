...
export module skeletonizer_mt:petrosino_salvi;
...
{
	class petrosino_salvi final : public backend_threads,
	...
	private:
		static void first_iteration(cv::Mat& binary_image, cv::Mat& marker)
		{
			...
			cv::parallel_for_(cv::Range(2, binary_image.rows - 2), [&](const cv::Range& range)
			{
