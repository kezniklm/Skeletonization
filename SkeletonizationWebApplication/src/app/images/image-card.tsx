...
import { Calendar, Check, Eye, ImageIcon, Pencil, Trash2, X } from "lucide-react";
...
export const ImageCard = ({ image, onDelete, onRename }: ImageCardProps) => {
  ...
  return (
    <Card className="group gap-1 overflow-hidden border-gray-200 bg-white pt-0 pb-2 shadow-sm backdrop-blur-sm transition-all duration-300 hover:border-cyan-300 hover:shadow-xl dark:border-gray-800 dark:bg-gray-900/95 dark:hover:border-cyan-700">
      ...
      <CardContent className="space-y-2.5 p-3">
        <div className="space-y-2">
          <div className="flex items-center gap-1.5">
            {isEditing ? (
              ...
              <>
                <h3
                  className="min-w-0 flex-1 truncate text-sm leading-tight font-semibold text-gray-900 dark:text-white"
          ...
          <div className="bg-muted/30 grid grid-cols-2 gap-2 rounded-lg p-2.5">
            <div className="flex items-center gap-1.5">
            ...
            <div className="border-muted col-span-2 flex items-center gap-1.5 border-t pt-2">
              <span className="text-muted-foreground text-xs font-semibold">Size:</span>
              <span className="text-xs font-bold text-gray-900 dark:text-white">{formatFileSize(image.sizeBytes)}</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex gap-2">
          <Button
            ...
            variant="outline"
            size="sm"
            className="flex-1 gap-2 border-cyan-200 bg-cyan-50 text-cyan-700 hover:bg-cyan-100 hover:text-cyan-800 dark:border-cyan-800 dark:bg-cyan-950 dark:text-cyan-300 dark:hover:bg-cyan-900"
          >
          ...
          <Button
            ...
            className="gap-2 border-red-200 bg-red-50 text-red-700 hover:bg-red-100 hover:text-red-800 dark:border-red-800 dark:bg-red-950 dark:text-red-300 dark:hover:bg-red-900"
          >
